  ...
  return (
    <div>
         <Navbar expand="lg" className="navbar_body-main" 
          ...
          <Container fluid>
           <Navbar.Brand href="/">
            <Image src='https://res.cloudinary.com/dtquwiu3x/image/upload/v1688572330/contact_f4fpct.png'  className='' style={{width: '40px', height: '40px'}}/>
           </Navbar.Brand>
          ...
          <Nav className="me-auto  my-lg-0 navbarcontent" style={{marginLeft:'350px'}} id='navbarcontent'>
            ...
            <a  href='#'  id='link_navbar_menu' style={{textDecoration:'none', color:'black'}}  >Contacts</a > 
